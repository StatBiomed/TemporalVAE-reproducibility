...
def calculate(species,
    ...
    cell_obs_time_min=cell_info['time'].min()
    ...
    for _s in stage_list:
        ...
        plt_allGene_dot_voteNum_meanDetT_Exp(cell_info.copy(), _stage_pert_data.copy(), perturb_gene_cor_data.copy(), file_path,
        ...
        _genes = []
        i = 0
        _all = _top_gene_list + enr_gene_list
        while len(_genes) < 4:
            _g = _all[i]
